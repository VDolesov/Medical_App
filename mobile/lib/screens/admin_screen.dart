          ...
          return Column(
            children: [
              Padding(
                ...
                child: Card(
                  child: ListTile(
                    ...
                    title: const Text('Пациенты и закрепление'),
                    subtitle: const Text('Назначение ведущего врача по ЛК'),
              ...
              Padding(
                ...
                child: Card(
                  child: ListTile(
                    leading: Icon(Icons.psychology_alt, color: Colors.indigo.shade700),
                    title: const Text('База знаний'),
                    subtitle: const Text('Клинические правила экспертной системы'),
                    trailing: const Icon(Icons.chevron_right),
