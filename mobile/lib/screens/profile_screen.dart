                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle: Text((user.email != null && user.email!.isNotEmpty) ? user.email! : 'Не указан'),
                        trailing: const Icon(Icons.copy, size: 20),
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                      ...
                      if (user.role == 'patient' &&
                          user.patientCode != null &&
                          user.patientCode!.isNotEmpty) ...[
                        const Divider(height: 1),
                        ListTile(
                          ...
                          onTap: () {
                            showDialog<void>(
                              ...
                              builder: (ctx) => AlertDialog(
                                title: const Text('Код пациента'),
                                content: Text(
                                  'Этот же код должен быть в колонке «code» в файле, который загружает врач. '
                                  'Тогда строка с вашими анализами появится в ваших отчётах.',
